...
initial begin
    ...
    out_file = $fopen("C:/Project/DSP in VLSI/Lab2_Filter/matlab/y_parallel_output.dat", "w");
...
always @(posedge clk) begin
    if (ValidOut) begin
        ...
        $fdisplay(out_file, "%0d", $signed(FilterOut0));
        $fdisplay(out_file, "%0d", $signed(FilterOut1));
