...
grid on;
exportgraphics(gcf, fullfile(fig_dir, 'step1_impulse_response.png'), 'Resolution', 150);
...
ylabel('Phase (radian)');
grid on;
exportgraphics(gcf, fullfile(fig_dir, 'step1_frequency_response.png'), 'Resolution', 150);